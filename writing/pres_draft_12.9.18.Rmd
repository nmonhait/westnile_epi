...
> - <span style="font-weight:bold; color:red;">This project fits into the broader scrope of WNV research by creating interactive tools to engage the public in the discussion of the prevalence of WNV.</span>
...
> - Problem: No useful information to display if filtering more than one demographic indicator, due to the small dataset
